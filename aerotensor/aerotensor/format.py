...
# Optional integrity (AIP-0001, AIP-0002)
FOURCC_IHSH = b"IHSH"    # integrity hash for header+TOC+string table (control plane)
FOURCC_PHSH = b"PHSH"    # page hashes for a WTSH shard (verify-by-page for remote)

# PHSH default page size (4 MiB) for content-addressed style range verify
PHSH_PAGE_SIZE_DEFAULT = 4 * 1024 * 1024
